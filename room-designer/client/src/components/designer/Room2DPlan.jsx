...
export default function Room2DPlan({
  ...
  return (
    ...
    >
      ...
      >
        {/* Room floor shape */}
        {(config.shape === "rectangle" || !config.shape) && (
          <rect
            x={padding}
            y={padding}
            width={roomRectWidth}
        ...
        {config.shape === "l-shape" && (
          <>
            ...
            <path
              d={`
                M ${padding} ${padding}
                L ${padding + roomRectWidth} ${padding}
                L ${padding + roomRectWidth} ${padding + roomRectHeight * 0.6}
                L ${padding + roomRectWidth * 0.6} ${padding + roomRectHeight * 0.6}
                L ${padding + roomRectWidth * 0.6} ${padding + roomRectHeight}
                L ${padding} ${padding + roomRectHeight}
                Z
              `}
              fill="#faf7f1"
              stroke="#7389b7"

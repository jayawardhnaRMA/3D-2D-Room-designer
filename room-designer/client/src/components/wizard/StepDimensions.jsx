...
function Dimension2DPreview({ length, width, unit }) {
  ...
  return (
    ...
    >
      <rect x="50" y="60" width="320" height="200" fill="none" stroke="#2563eb" strokeWidth="2" />
      <text x="210" y="155" textAnchor="middle" fill="#2563eb" fontSize="14" fontWeight="700">
        {displayLength}
      </text>
      <text x="110" y="280" textAnchor="middle" fill="#2563eb" fontSize="14" fontWeight="700">
        {displayWidth}
      </text>
    </svg>
  );
